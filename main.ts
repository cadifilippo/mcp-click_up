...
server.tool(
  'list_spaces',
  'Lista los espacios de mi equipo en ClickUp',
...
server.tool(
  'list_folders',
  'Obtiene las carpetas de un space dado',
  { space_id: z.string().describe('Id del espacio') },
  async ({ space_id }) => {
...
server.tool(
  ...
  { folder_id: z.string().describe('Id de la carpeta') },
  async ({ folder_id }) => {
